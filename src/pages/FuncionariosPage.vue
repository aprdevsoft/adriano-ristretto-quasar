  ...
  <q-page padding>
    <q-card flat bordered class="my-card">
      <q-card-actions class="bg-primary text-white header" align="between">
        <div class="text-h6">Cadastro de Funcionários</div>
        <q-btn
          color="white"
          text-color="indigo"
          label="Novo Cadastro"
...
import FuncionarioTable from './funcionario/FuncionarioTable.vue';
import CadastroFuncionario from './funcionario/CadastroFuncionario.vue';

export default defineComponent({
  name: 'FuncionariosPage',
  components: { FuncionarioTable, CadastroFuncionario },
  setup() {
    return {
      cadastro: ref(false),
      text: ref(''),
